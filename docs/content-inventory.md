...
| Portrait/media | Not implemented because no approved portrait or OpenGraph image asset exists. |
...
| Education | Engineering Degree in Computer Science and Networks - ENSISA - graduated - 2022-2025; DUT Computer Science - IUT Robert Schuman - 2020-2022; semester abroad at UQAC during DUT studies. | First bilingual education timeline implemented. | Exact locations, coursework, honors, credential URLs, approved school logo usage, exact UQAC semester dates if public. | Keep degree naming accurate in both locales. |
