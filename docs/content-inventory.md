...
| Portrait          | Approved source master retained unchanged at `frontend/public/assets/portrait/baptiste-wetterwald-portrait.png`; normal page delivery uses versioned 240w/480w AVIF and WebP derivatives with the same CSS object cropping inside the porthole frame. |
